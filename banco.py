...
def criar_conta() -> None:
    print('Informe os dados do cliete: ')
...
def efetuar_tranferencia() -> None:
    if len(contas) > 0:
        numero_o: int = int(input('Informeo número da sua conta: '))

        conta_o: Conta = buscar_conta_por_numero(numero_o)

        if conta_o:
            numero_d: int = int(input('Informe o npumero da conta destino: '))
